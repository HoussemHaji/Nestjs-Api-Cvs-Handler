...
var JwtStrategy = /** @class */ (function (_super) {
    ...
    JwtStrategy.prototype.validate = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var user, password, salt, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepo.findOneBy({ username: payload.username })];
                    case 1:
                        user = _a.sent();
                        if (user) {
                            password = user.password, salt = user.salt, result = __rest(user, ["password", "salt"]);
